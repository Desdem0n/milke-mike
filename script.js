...
const translations = {
  pl: {
    ...
    "Brand": "Brand",
    "Website build": "Budowa strony",
    "Meble na Wymiar website": "Strona Meble na Wymiar",
    "Service landing page with hero, navigation, realization gallery and contact path for a custom furniture business.": "Landing page uslugi z hero, nawigacja, galeria realizacji i sciezka kontaktu dla firmy robiacej meble na wymiar.",
    "Game environment": "Srodowisko gry",
    "Last Pagans atmosphere scene": "Scena atmosferyczna Last Pagans",
    "Mood-heavy realtime-style scene showing world-building, lighting direction and interactive app storytelling.": "Nastrojowa scena w stylu realtime pokazujaca world-building, kierunek swiatla i storytelling aplikacji interaktywnej.",
    "App pricing UI": "UI cennika aplikacji",
    "Subscription checkout screen": "Ekran wyboru subskrypcji",
    "Purple pricing flow for monthly and yearly plans, focused on a fast, readable app purchase decision.": "Fioletowy flow cennika dla planu miesiecznego i rocznego, skupiony na szybkiej i czytelnej decyzji zakupowej.",
    "Retail website visual": "Wizual strony retail",
    "Fauchon candy shop concept": "Koncept Fauchon candy shop",
    "Architectural retail render with strong facade identity, suitable for a premium shop website or campaign case.": "Architektoniczny render retail z mocna tozsamoscia fasady, dobry pod strone sklepu premium albo case kampanii.",
    "MILKE": "MILKE",
