...
const translations = {
  pl: {
    ...
    "GitHub": "GitHub",
    "Contact": "Kontakt",
    "Job-ready profile • moving portfolio hook • web & app creator": "Portfolio gotowe do rozmów • żywy pierwszy ekran • strony i aplikacje",
    "I build digital experiences with visual depth.": "Projektuję cyfrowe doświadczenia, które mają obraz, rytm i cel.",
    "Product Designer and front-end creator with architecture, 3D visualization, marketing and SAP UI5 experience. I build websites, app concepts and visual systems that make ideas understandable fast.": "Łączę projektowanie produktu, front-end, architekturę, wizualizację 3D, marketing i SAP UI5. Tworzę strony, koncepcje aplikacji i język wizualny, który od pierwszych sekund prowadzi odbiorcę do sedna.",
    ...
    "Website & app creator with 3D instincts": "Twórca stron i aplikacji z wyczuciem przestrzeni",
    "From cinematic assets to clickable web products, with a strong eye for composition and conversion.": "Od dopracowanych wizuali po działające produkty webowe. Z dbałością o kompozycję, czytelność i decyzję użytkownika.",
    "selected works shown": "wybranych prac",
    "core disciplines": "główne obszary",
    "May 2026 app build": "aplikacja z maja 2026",
    "portfolio focus": "kierunek portfolio",
    "Profile": "Profil",
    "A creator who can make a product look real before it exists.": "Potrafię nadać pomysłowi wiarygodny kształt, zanim stanie się gotowym produktem.",
    "I started my career as a graphic designer, worked with marketing campaigns and developed a strong customer-facing mindset. My architecture education and 3D visualization work give me a rare visual foundation for web and app creation: I can shape both the interface and the story behind it.": "Zaczynałem od grafiki i kampanii marketingowych, później doszły architektura, wizualizacja 3D oraz praca blisko klienta. Dzięki temu projektuję nie tylko ekran, ale też opowieść, tempo i pierwsze wrażenie, które pomagają produktowi zostać dobrze zrozumianym.",
    "3D visualization": "Wizualizacja 3D",
    "Landing pages": "Strony sprzedażowe",
    "App UI": "Interfejsy aplikacji",
    "Customer relations": "Relacje z klientem",
    "Portfolio direction": "Kierunek portfolio",
    "Built for a hiring manager’s first 90 seconds.": "Ułożone tak, by pierwsze 90 sekund pracowało na Twoją korzyść.",
    "Selected work": "Wybrane prace",
    "Visual projects, websites and app-ready product thinking.": "Wizualizacje, strony i pomysły produktowe gotowe do przekucia w aplikacje.",
    "All": "Wszystkie",
    "Websites": "Strony",
    "Apps": "Aplikacje",
    "3D / renders": "3D / rendery",
    "Brand": "Marka",
    "Website build": "Realizacja strony",
    "Meble na Wymiar website": "Strona Meble na Wymiar",
    "Service landing page with hero, navigation, realization gallery and contact path for a custom furniture business.": "Strona usługowa z mocnym pierwszym ekranem, prostą nawigacją, galerią realizacji i jasną drogą do kontaktu.",
    "Game environment": "Świat gry",
    "Last Pagans atmosphere scene": "Mroczna osada Last Pagans",
    "Mood-heavy realtime-style scene showing world-building, lighting direction and interactive app storytelling.": "Nastrojowa scena budująca klimat świata gry: światło prowadzi wzrok, a przestrzeń od razu sugeruje historię i interakcję.",
    "App pricing UI": "Ekran wyboru planu",
    "Subscription checkout screen": "Ekran wyboru subskrypcji",
    "Purple pricing flow for monthly and yearly plans, focused on a fast, readable app purchase decision.": "Czytelny ekran płatności, który bez zbędnych kroków prowadzi użytkownika do wyboru planu.",
    "Retail website visual": "Wizual dla marki handlowej",
    "Fauchon candy shop concept": "Koncept butiku Fauchon",
    "Architectural retail render with strong facade identity, suitable for a premium shop website or campaign case.": "Render lokalu z wyrazistą fasadą i charakterem marki, gotowy na stronę premium, kampanię lub prezentację inwestorską.",
    "MILKE": "MILKE",
    "Pack shot visual": "Pack shot visual",
    "Part of a campaign pack shot system for MILKE.se, built to present the product in a polished residential context.": "Element kampanii produktowej MILKE.se: wnętrze zbudowane tak, by produkt wyglądał naturalnie, wiarygodnie i sprzedażowo.",
    "Creator skills": "Kompetencje",
    "The route from websites to apps.": "Od strony internetowej do działającej aplikacji.",
    ...
    "Premium residential scene": "Wnętrze z półki premium",
    "Lighting, mood and composition prepared for a high-end website hero or property presentation.": "Światło, nastrój i kadr ustawione tak, by od razu budować wartość nieruchomości lub marki.",
    "Architecture product": "Produkt architektoniczny",
    "Hidden doors visual story": "Drzwi ukryte pokazane bez szumu",
    "Clean product-led render that can sell a design detail without extra explanation.": "Oszczędny render produktowy, w którym detal sam robi robotę.",
    "Commercial interiors": "Wnętrza komercyjne",
    "Brand banner system": "System banerów marki",
    "Website-ready horizontal artwork for a boutique and commercial interior presentation.": "Szeroki kadr gotowy pod stronę, baner lub prezentację wnętrz komercyjnych.",
    "Industrial visual": "Komunikacja industrialna",
    "STOW warehouse campaign": "Kampania magazynowa STOW",
    "Large-scale industrial image treatment with strong contrast and campaign typography.": "Mocny obraz przemysłowy z czytelną typografią i kampanijnym charakterem.",
    ...
    "Process proof": "Proces od kuchni",
    "From 3D scene to product visual": "Od sceny 3D do wizualu produktu",
    "Shows technical production skill, camera setup, lighting and complex asset organization.": "Pokazuje warsztat: kamerę, światło, skalę sceny i panowanie nad złożonym materiałem.",
    "Cinematic render": "Render filmowy",
    "Industrial storytelling": "Opowieść o skali i technologii",
    "A more emotional scene built for a brand narrative, launch page or trade presentation.": "Scena z większym ładunkiem emocji, dobra pod narrację marki, premierę produktu albo prezentację targową.",
    "Interior detail": "Detal wnętrza",
    "Bathroom product scene": "Scena produktowa łazienki",
    "Material control, reflections and clean product framing for lifestyle presentation.": "Materiały, odbicia i kadr dopracowane tak, by produkt wyglądał świeżo i wiarygodnie.",
    ...
    "Technical workflow": "Warsztat techniczny",
    "Clay viewport documentation": "Dokumentacja sceny 3D",
    "Behind-the-scenes proof that complex scenes are designed, not guessed.": "Kadr zza kulis, który pokazuje, że złożone sceny powstają z decyzji, a nie przypadku.",
    "Clay interior study": "Studium wnętrza w clay renderze",
    "Kitchen composition test": "Test kompozycji kuchni",
    "Monochrome lighting and layout study showing camera, proportions and spatial decision-making.": "Monochromatyczne studium światła i układu, w którym widać kontrolę nad kamerą, proporcjami i przestrzenią.",
    "Bathroom visualization": "Wizualizacja łazienki",
    "Kamila bathroom scene": "Scena łazienki Kamila",
    "Detailed lighting, materials and atmosphere prepared as a strong portfolio-grade interior case.": "Dopracowane światło, materiały i atmosfera, które zamieniają wnętrze w pełnoprawny case portfolio.",
    ...
    "Warm lighting, city context and premium visual tone for lifestyle communication.": "Ciepłe światło, miasto w tle i elegancki ton wizualny dla komunikacji lifestyle.",
    "3D modeling": "Modelowanie 3D",
    "Storage product prototype": "Prototyp systemu przechowywania",
    "Clay render showing model structure, component logic and presentation discipline.": "Clay render pokazujący konstrukcję modelu, logikę elementów i porządek w prezentacji.",
    "Experimental visual": "Wizual eksperymentalny",
    "Light concept poster": "Plakat koncepcyjny światła",
    "Graphic exploration of transparency, typography and contrast for an editorial or landing-page accent.": "Graficzne ćwiczenie z przezroczystości, typografii i kontrastu, dobre jako mocny akcent na stronie lub w materiale redakcyjnym.",
    ...
    "Editorial banner asset": "Kadr editorialowy",
    "Soft, cinematic website visual for a calm landing page, blog header or product mood section.": "Miękki, filmowy obraz pod spokojny landing page, nagłówek artykułu albo sekcję nastroju.",
    "Brief": "Brief",
    "Define the audience, the promise and what the employer or client must understand instantly.": "Najpierw odbiorca, obietnica i jeden komunikat, który musi wybrzmieć od razu.",
    "Visual system": "System wizualny",
    "Use 3D composition, image rhythm and typography to create a premium first impression.": "Kompozycja 3D, rytm obrazów i typografia pracują razem na mocne pierwsze wrażenie.",
    "Build": "Budowa",
    "Turn the idea into HTML, CSS and JavaScript with responsive layout and useful interactions.": "Pomysł trafia do HTML, CSS i JavaScriptu jako responsywny, klikalny i użyteczny produkt.",
    "Ship": "Publikacja",
    "Package the story for GitHub, portfolio review, recruiters and the next real product iteration.": "Całość jest przygotowana pod GitHub, rozmowę rekrutacyjną, klienta i kolejny realny etap produktu.",
    "Website creator": "Twórca stron",
    "App creator": "Twórca aplikacji",
    "Visual producer": "Producent wizualny",
    "Front-end builds, app concepts and experiments.": "Front-end, koncepcje aplikacji i prototypy.",
    "Websites, apps, 3D visuals and product storytelling.": "Strony, aplikacje, wizualizacje 3D i opowieść wokół produktu."
  },
  ru: {
    "Work": "Работы",
    "FareScout": "FareScout",
